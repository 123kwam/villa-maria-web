        ...
        <div className="grid gap-10 md:grid-cols-12 md:gap-12">
          ...
          <div className="md:col-span-8">
            <div className="grid grid-cols-6 grid-rows-6 gap-3 md:gap-4 aspect-[5/6] md:aspect-[6/5]">
              <Reveal className="col-span-6 row-span-4 md:col-span-4 md:row-span-6">
              ...
              <Reveal delay={120} className="col-span-3 row-span-2 md:col-span-2 md:row-span-3">
                <figure className="relative h-full w-full overflow-hidden">
                  <Image
              ...
              <Reveal delay={240} className="col-span-3 row-span-2 md:col-span-2 md:row-span-3">
                <figure className="relative h-full w-full overflow-hidden">
                  <Image
